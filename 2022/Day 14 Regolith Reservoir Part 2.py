...
def create_frame(grid, t):
    ...
    plt.savefig(f'./img/day14_2/img_{t}.png', transparent = False, facecolor = 'white')
...
frames = []
for t in range(0, units, mod):
    image = imageio.v2.imread(f'./img/day14_2/img_{t}.png')
    frames.append(image)
frames.append(f'./img/day14_2/img_{units}.png')
    
imageio.mimwrite('./Day 14 Regolith Reservoir Part 2 Timelapse.gif', frames, fps=1)